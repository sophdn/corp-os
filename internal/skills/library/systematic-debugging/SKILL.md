...
For complex multi-component debugging, dispatch an investigation subagent (e.g. via the `Agent` tool with `subagent_type=Explore` or `general-purpose`). Brief it like a smart colleague who just walked into the room: explain the error, the suspected scope, what you've already tried, and what kind of report you want back ("findings only, do not fix"). The subagent reads files independently and returns a structured report you can act on.
